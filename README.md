# 🦠 Cyber Survivors
GAME LINK: https://cybersurvivors.onrender.com/ <br />
...
## 📜 License
### 🖥 Code
The source code of **Cyber Survivors** is licensed under the **MIT License** – see the [LICENSE](./LICENSE) file for details.  
